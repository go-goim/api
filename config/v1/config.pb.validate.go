...
// Validate checks the field values on HBase with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *HBase) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on HBase with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in HBaseMultiError, or nil if none found.
func (m *HBase) ValidateAll() error {
	return m.validate(true)
}

func (m *HBase) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return HBaseMultiError(errors)
	}

	return nil
}

// HBaseMultiError is an error wrapping multiple validation errors returned by
// HBase.ValidateAll() if the designated constraints aren't met.
type HBaseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m HBaseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m HBaseMultiError) AllErrors() []error { return m }

// HBaseValidationError is the validation error returned by HBase.Validate if
// the designated constraints aren't met.
type HBaseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e HBaseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e HBaseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e HBaseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e HBaseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e HBaseValidationError) ErrorName() string { return "HBaseValidationError" }

// Error satisfies the builtin error interface
func (e HBaseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = HBaseValidationError{}
