...
const (
	...
	UserService_QueryUser_FullMethodName  = "/api.user.v1.UserService/QueryUser"
...
func (c *userServiceClient) GetUser(ctx context.Context, in *GetUserInfoRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (c *userServiceClient) QueryUser(ctx context.Context, in *QueryUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
func (UnimplementedUserServiceServer) GetUser(context.Context, *GetUserInfoRequest) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUser not implemented")
}
func (UnimplementedUserServiceServer) QueryUser(context.Context, *QueryUserRequest) (*UserResponse, error) {
