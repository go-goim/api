...
const (
	SessionType_UserToUser SessionType = 0
...
const (
	SessionStatus_Normal  SessionStatus = 0
	SessionStatus_Deleted SessionStatus = 1
)
...
func (SessionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_user_session_v1_session_proto_enumTypes[1].Descriptor()
}

func (SessionStatus) Type() protoreflect.EnumType {
	return &file_user_session_v1_session_proto_enumTypes[1]
}
...
var file_user_session_v1_session_proto_rawDesc = []byte{
	...
	0x79, 0x70, 0x65, 0x12, 0x0e, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x54, 0x6f, 0x55, 0x73, 0x65,
	0x72, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x43, 0x68, 0x61, 0x74,
	0x10, 0x01, 0x2a, 0x28, 0x0a, 0x0d, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x0a, 0x0a, 0x06, 0x4e, 0x6f, 0x72, 0x6d, 0x61, 0x6c, 0x10, 0x00, 0x12,
	0x0b, 0x0a, 0x07, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x10, 0x01, 0x42, 0x28, 0x5a, 0x26,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x2d, 0x67, 0x6f,
	0x69, 0x6d, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x73, 0x65, 0x73, 0x73,
...
var file_user_session_v1_session_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_user_session_v1_session_proto_goTypes = []interface{}{
	(SessionType)(0),   // 0: api.user.session.v1.SessionType
	(SessionStatus)(0), // 1: api.user.session.v1.SessionStatus
}
