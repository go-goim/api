...
const (
	GroupService_GetGroup_FullMethodName          = "/api.user.group.v1.GroupService/GetGroup"
	GroupService_ListGroups_FullMethodName        = "/api.user.group.v1.GroupService/ListGroups"
	GroupService_CreateGroup_FullMethodName       = "/api.user.group.v1.GroupService/CreateGroup"
	GroupService_UpdateGroup_FullMethodName       = "/api.user.group.v1.GroupService/UpdateGroup"
	GroupService_DeleteGroup_FullMethodName       = "/api.user.group.v1.GroupService/DeleteGroup"
	GroupService_AddGroupMember_FullMethodName    = "/api.user.group.v1.GroupService/AddGroupMember"
	GroupService_RemoveGroupMember_FullMethodName = "/api.user.group.v1.GroupService/RemoveGroupMember"
)
